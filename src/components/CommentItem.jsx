...
const CommentItem = ({ comment, owner, createdAt }) => {
  ...
  return (
    <View
      ...
      <Image source={owner.avatar ? { uri: owner.avatar } : defaultUserAvatar} alt='User photo' style={styles.avatar} />
      <View
        style={{
          ...styles.commentWrap,
        ...
        <Text style={userId !== owner.userId ? styles.dateUser : styles.dateOwner}>
